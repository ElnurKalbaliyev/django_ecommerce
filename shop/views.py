...
def product_detail(request, pk, slug):
    ...
    # other_products = Products.objects.filter(categories_in=product.categories.all().annotate(common_product_count=Count('pk'))).exclude(pk=product.pk).order_by('-common_product_count')
